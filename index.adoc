...
----
And ::
I can assure that `fail?` alias works icon:thumbs-up[role="green",title="Passed"]
----
...
----
And ::
I can assure that `failed?` alias works icon:thumbs-up[role="green",title="Passed"]
----
